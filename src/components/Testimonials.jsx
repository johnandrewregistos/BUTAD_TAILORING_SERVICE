...
const Testimonials = () => {
    return (
        <section className='w-full h-[100vh] grid place-items-center py-3 md:py-6' id='testimonials'>
            <h1 className='text-3xl py-5'>TESTIMONIALS</h1>
            <div className="container grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-0 mx-auto">
                {/* 1st */}
                <div className="w-full md:w-5/6 mx-auto text-center px-3 md:px-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="inline-block w-8 h-8 text-[#FFED00] mb-8" viewBox="0 0 975.036 975.036">
                ...
                <div className="w-full md:w-5/6 mx-auto text-center px-3 md:px-0">
                    ...
                    <p className="leading-relaxed text-gray-500 text-lg">Choosing this tailoring shop was the best decision I made for my wedding dress. They listened to my ideas and brought them to life with exquisite precision. The gown fit like a dream, accentuating my figure in the most flattering way. The team's professionalism and passion for their work truly shone through. Thank you for making my special day even more magical!</p>
                    <span className="inline-block h-1 w-10 rounded bg-[#FFED00] mt-8 mb-6"></span>
