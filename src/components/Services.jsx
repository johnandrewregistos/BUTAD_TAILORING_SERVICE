    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center px-3 py-6' id='services'>
            ...
            <div className="w-full h-full flex flex-col md:flex-row justify-evenly items-center">
                {/* 1st */}
                <div className="w-full md:w-1/4 h-[360px] md:h-[540px] flex flex-col  items-center px-3">
                    ...
                    <h1 className='my-3 text-lg md:text-2xl'>Custom Tailoring</h1>
                    <p className='text-sm md:text-lg flex justify-evenly items-center mb-3'>We provide custom tailoring service so that you can choose all details you want, from buttons to pockets and lapels, we can do everything.</p>
                    <Link to='contacts' smooth={true} spy={true} className="bg-[#FFED00] text-black tracking-wider px-4 py-0 md:py-2 hover:bg-amber-500 rounded-full cursor-pointer">INQUIRE</Link>
                </div>
                {/* 2nd */}
                <div className="w-full md:w-1/4 h-[360px] md:h-[540px] flex flex-col  items-center px-3">
                    ...
                    <h1 className='my-3 text-lg md:text-2xl'>Altering/Repair</h1>
                    <p className='text-sm md:text-lg flex justify-evenly items-center mb-3'>The perfect cut for your outfit is something we believe in. We are engaged in offering best altering options helping you look more classy.</p>
                    <Link to='contacts' smooth={true} spy={true} className="bg-[#FFED00] text-black tracking-wider px-4 py-0 md:py-2 hover:bg-amber-500 rounded-full cursor-pointer">INQUIRE</Link>
                </div>
                {/* 3rd */}
                <div className="w-full md:w-1/4 h-[360px] md:h-[540px] flex flex-col  items-center px-3">
                    ...
                    <h1 className='my-3 text-lg md:text-2xl'>Home Visit Tailor Services</h1>
                    <p className='text-sm md:text-lg flex justify-evenly items-center mb-3'>
                ...
                <div className="w-full md:w-1/4 h-[360px] md:h-[540px] flex flex-col  items-center px-3">
                    ...
                    <h1 className='my-3 text-lg md:text-2xl'>Uniforms</h1>
                    <p className='text-sm md:text-lg flex justify-evenly items-center mb-3'>
